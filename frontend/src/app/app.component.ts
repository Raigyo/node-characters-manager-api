...
export class AppComponent {
  ...
  async saveItem(item: any) {
    try {
      ...
      console.log('calling create item endpoint with: ' + item.name + ',' + item.shortDescription + ','
  ...
  async updateItem(item: any) {
    try {
      ...
      console.log('calling update endpoint with id ' + item.id +
      ' and value "' + item.name + ',' + item.shortDescription + ',' + item.description  + ',' + item.image);
